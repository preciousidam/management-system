...
class Apartment(models.Model):
    ...
    no_of_bath = models.IntegerField(_("Number of Bathrooms"))
    no_of_toilet = models.IntegerField(_("Number of Toilets"))
    no_of_park = models.IntegerField(_("Number of Car Park"))
